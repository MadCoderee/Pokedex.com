      ...
      <nav class="navbar">
        ...
        <div class="navbar-links">
          <ul>
            ...
            <li><a href="http://localhost:8888/eyeQ/signup.html">Signup</a></li>
...
<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO Pokedex (sprite,name,type,type2,evolution) values(?, ?, ?, ?, ?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($sprite,$name,$type,$type2,$evolution));
                ...
                <div class="span10 offset1">
                    ...
                    <div class="control-group <?php echo !empty($sprite)?'error':'';?>">
                      ...
                      <div class="form-actions">
                          <button type="submit" href="Pokedex.php" class="btn btn-success">Create</button>
